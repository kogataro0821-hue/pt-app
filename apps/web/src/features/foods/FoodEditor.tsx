    ...
    <section className="card">
      ...
      <label className="field">
        ...
        <span className="field-hint">
          ...
          {/* ★ ひらがなで当てたいなら、読みを入れるしかありません。
                 漢字を読みに直す処理はアプリ側で持てないので（辞書が要ります）、
                 「とうふ」と打って「豆腐」に当たることはありません。 */}
          <br />
          ひらがなで打って当てたいときは、<b>読みを入れてください</b>（豆腐 →「とうふ」）。
          <br />
          {/* ★ 同じ別名を複数の食材に付けるのは、わざとの使い方です。
                 以前はこれを「ぶつかっています」と警告していたので、
                 使ってはいけないものだと読まれていました。 */}
          <b>同じ別名を複数の食材に付けられます。</b>
